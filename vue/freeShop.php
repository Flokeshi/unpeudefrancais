...
<head>
    ...
    <!-- Document title -->
    <title>Un Peu de Français : Free</title>
...
<body>
    ...
    <div class="body-inner" id="scrollbehavior">
        ...
        $products=$bdd->prepare("SELECT * FROM product LEFT JOIN category ON product.category_id=category.category_id LEFT JOIN cart_details ON product.product_id = cart_details.product_num AND cart_num=:cart_id WHERE product_price IS NULL ORDER BY product_name ASC");
                            ...
                            <div class="product">
                                ...
                                <div class="product-description">
                                    ...
                                    <div class="cart-product-quantity row">
                                        ...
                                        <div class="col-3">
                                            <a href="<?php echo $productRow["product_url"]; ?>" download="<?php echo $productRow["product_name"]; ?>"><button class="btn btn-primary" id="btn-submit-<?= $productRow['product_id']?>"><i class="fas fa-arrow-down"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
