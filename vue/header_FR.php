        ...
        <div class="container">
            ...
            <div id="search"><a id="btn-search-close" class="btn-search-close" aria-label="Close search form"><i class="icon-x"></i></a>
                <form class="search-form" action="shop.php" method="get">
                    ...
                    <span class="text-muted">Commencez à écrire et pressez sur "Entrée" ou "Echap" pour fermer la fenêtre</span>
                </form>
            </div>
            <!-- end: search -->
            <!--Header Extras-->
                ...
                <div class="container">
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a href="../vue/freeShop.php"><i class="fas fa-file-download"></i>Gratuit</a>
                            
                            <li class="dropdown mega-menu-item"><a href="../vue/shop.php"><i class="fas fa-shopping-bag"></i></i>Magasin</a>
                            ...
                            <?php if (!isset($_SESSION['idUser'])) { ?>
                                <li><a href="../vue/connexion_page.php"><i class="fas fa-sign-in-alt"></i>Connexion</a>
                            <?php }else{ ?>
                                <li class="dropdown"><a href="../vue/account_page.php"><i class="fa fa-user"></i>Mon compte</a>
                            <?php 
                            } 
                            ...
                            <li class="dropdown"><a href="../vue/cart_page.php"><i class="fas fa-shopping-cart"></i></i>Panier</a>  
                                <!-- <ul class="dropdown-menu">
                                    <li class="p-dropdown-content">
