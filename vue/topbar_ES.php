        ...
        <div class="row">
            <div class="col-md-6">
                <div class="topbar-dropdown">
                    <a class="title">Spanish <i class="fa fa-caret-down"></i></a>
                ...
                <div class="topbar-dropdown">
                    <div class="title">
                        <?php if (!isset($_SESSION['idUser'])) { ?>
                            ...
                            <a href="../vue/connexion_page.php"> Conexión</a>
                        <?php }else{ ?>
                            <i class="fa fa-user"></i>
                            <a href="../vue/account_page.php"> Mi cuenta</a>
                        <?php }?>
                    </div>
                    <?php
                ...
                <div class="topbar-dropdown">
                    <div class="title"><i class="icon-info"></i><a href="../vue/about.php"> Sobre</a></div>
                </div>
                ...
                <?php } else if ($_SESSION['role'] == 'admin') { ?>
                    ...
                    <div class="topbar-dropdown">
                        <div class="title"><i class="fas fa-wrench"></i><a href="../vue/dashboard_page.php"> Tablero de mandos</a></div>
                    </div>                          
                <?php } ?>
