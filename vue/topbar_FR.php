        ...
        <div class="row">
            <div class="col-md-6">
                <div class="topbar-dropdown">
                    <a class="title">French <i class="fa fa-caret-down"></i></a>
                    <div class="dropdown-list">
                        <a class="list-entry" href="../controller/traitement_EN.php">English</a>
                ...
                <div class="topbar-dropdown">
                    <div class="title">
                        <?php if (!isset($_SESSION['idUser'])) { ?>
                            ...
                            <a href="../vue/connexion_page.php"> Connexion</a>
                        <?php }else{ ?>
                            <i class="fa fa-user"></i>
                            <a href="../vue/account_page.php"> Mon compte</a>
                        <?php }?>
                    </div>
                    <?php
                ...
                <div class="topbar-dropdown">
                    <div class="title"><i class="icon-info"></i><a href="../vue/about.php"> A propos</a></div>
                </div>
                ...
                <?php } else if ($_SESSION['role'] == 'admin') { ?>
                    ...
                    <div class="topbar-dropdown">
                        <div class="title"><i class="fas fa-wrench"></i><a href="../vue/dashboard_page.php"> Interface administrateur</a></div>
                    </div>                          
                <?php } ?>
