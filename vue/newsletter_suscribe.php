...
<body>
    ...
    <div class="body-inner" id="scrollbehavior">
        ...
        <div class="text-center w-50 p-10 m-auto">
            <h3 class="m-t-50">Pour vous inscrire à la newsletter, veuillez renseigner votre adresse e-mail :</h3>
            <form method="POST" action="../controller/traitement_newsletter_suscribe.php" class="m-50">
                ...
                if (isset($_GET["success"])) {
                    if ($_GET["success"] == "suscribe") {
                        echo "<div class='form-group'><div class='alert alert-success' style='font-size: 18px; color: black; z-index:1;'>Votre inscription a bien été prise en compte.</div></div>";
                    }
                }
                ...
                <div class=" form-group btn-submit">
                    <button type="submit" class="btn btn-success" style="font-size:18px; color:black; letter-spacing:3px;">Submit</button>
                </div>
            </form>
        </div>
    </div>
