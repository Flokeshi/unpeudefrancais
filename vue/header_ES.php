        ...
        <div class="container">
            ...
            <div id="search"><a id="btn-search-close" class="btn-search-close" aria-label="Close search form"><i class="icon-x"></i></a>
                <form class="search-form" action="shop.php" method="get">
                    ...
                    <span class="text-muted">Comience a escribir y presione "Enter" o "ESC" para cerrar</span>
                </form>
            </div>
            <!-- end: search -->
            <!--Header Extras-->
                    ...
                    <li>
                        <div class="p-dropdown"> <a href="#"><i class="icon-globe"></i><span>ES</span></a>
                            <ul class="p-dropdown-content">
                                ...
                                <li><a>Spanish</a></li>
                                <li><a href="../controller/traitement_EN.php">English</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                ...
                <div class="container">
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a href="../public/index.php"><i class="fas fa-home"></i>Recepción</a></li>

                            <li><a href="../vue/freeShop.php"><i class="fas fa-file-download"></i>Gratis</a>
                            
                            <li class="dropdown mega-menu-item"><a href="../vue/shop.php"><i class="fas fa-shopping-bag"></i></i>Tienda</a>
                            ...
                            <?php if (!isset($_SESSION['idUser'])) { ?>
                                <li><a href="../vue/connexion_page.php"><i class="fas fa-sign-in-alt"></i>Conexión</a>
                            <?php }else{ ?>
                                <li class="dropdown"><a href="../vue/account_page.php"><i class="fa fa-user"></i>Mi cuenta</a>
                            <?php 
                            } 
                            ...
                            <li class="dropdown"><a href="../vue/cart_page.php"><i class="fas fa-shopping-cart"></i></i>Cesta</a>  
                                <!-- <ul class="dropdown-menu">
                                    <li class="p-dropdown-content">
