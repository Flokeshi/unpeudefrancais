                ...
                <div class="container">
                    <nav>
                        <ul class="menu">
                            ...
                            <li><a href="../public/index.php"><i class="icon-home"></i>Home</a></li>

                            <li><a href="../vue/about.php"><i class="icon-info"></i>About</a></li> 
                            
                            <li class="dropdown mega-menu-item"><a href="../vue/shop.php"><i class="icon-shopping-bag"></i>Shop</a>
                            ...
                            <?php if (!isset($_SESSION['idUser'])) { ?>
                                <li><a href="../vue/connexion_page.php"><i class="icon-log-in"></i>Log in</a>
                            <?php }else{ ?>
                            ...
                            <li class="dropdown"><a href="../vue/cart_page.php"><i class="icon-shopping-cart"></i>Cart</a>  
                                <!-- <ul class="dropdown-menu">
                                    <li class="p-dropdown-content">
